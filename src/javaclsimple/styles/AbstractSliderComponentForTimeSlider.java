 ...
 * @author abordier
 */
public abstract class AbstractSliderComponentForTimeSlider extends JComponent {
    ...
    public AbstractSliderComponentForTimeSlider(final double limitMin, final double limitMax) {
